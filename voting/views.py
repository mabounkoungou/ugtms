...
def generate_ballot(display_controls=False):
    ...
    for position in positions:
        ...
        for candidate in candidates:
            ...
            candidates_data = candidates_data + '<li>' + input_box + '<button type="button" class="btn btn-primary btn-sm btn-rounded clist platform" data-fullname="'+candidate.fullname+'" data-bio="'+candidate.bio+'"><i class="fa fa-search"></i> Platform</button><img src="' + \
        ...
        <button type="button" class="btn btn-success btn-sm btn-rounded reset" data-desc="{position_name}"><i class="fa fa-refresh"></i> Reset</button>
        </span>
        </p>
